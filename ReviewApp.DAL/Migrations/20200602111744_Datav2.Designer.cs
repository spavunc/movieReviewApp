...
namespace ReviewApp.Data.Migrations
{
    ...
    [Migration("20200602111744_Datav2")]
    partial class Datav2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReviewApp.Model.Movie", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 9999, CountryOfRelease = "USA", DirectorID = 999, DurationMinutes = 103, ReleaseDate = new DateTime(1998, 7, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), Synopsis = "An insurance salesman discovers his whole life is actually a reality TV show. ", Title = "The Truman Show" }
                    );
                });
            ...
            modelBuilder.Entity("ReviewApp.Model.Person", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 999, CountryOfBirth = "Australia", Description = "Peter Weir was born on August 21, 1944 in Sydney, New South Wales, Australia as Peter Lindsay Weir. He is a director and writer, known for Master and Commander: The Far Side of the World (2003), The Way Back (2010) and The Truman Show (1998). He has been married to Wendy Stites since 1966. They have two children.", FirstName = "Peter", Gender = "M", LastName = "Weir", PlaceOfBirth = "Sydney" }
                    );
                });

            modelBuilder.Entity("ReviewApp.Model.Rating", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ReviewApp.Model.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ReviewApp.Model.Rating", b =>
                {
                    ...
                    b.HasOne("ReviewApp.Model.AppUser", "User")
                        .WithMany("UserRatings")
                        .HasForeignKey("UserID");
                });
