...
namespace ReviewApp.Data.Migrations
{
    ...
    [Migration("20200531165604_Ratingsv2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReviewApp.Model.UserRating", b =>
                {
                    b.Property<string>("UserId");
            ...
            modelBuilder.Entity("ReviewApp.Model.Rating", b =>
                {
                    b.HasOne("ReviewApp.Model.Movie")
                        .WithMany("UserRatings")
                        .HasForeignKey("MovieID");

                    b.HasOne("ReviewApp.Model.Show")
                        .WithMany("UserRatings")
            ...
            modelBuilder.Entity("ReviewApp.Model.UserRating", b =>
                {
                    b.HasOne("ReviewApp.Model.Rating", "Rating")
                        .WithMany("UserRatings")
